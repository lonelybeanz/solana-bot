...
func BonkSwap(
	...
	binary.LittleEndian.PutUint64(buf[16:], minOut*90/100)
	...
	acctMetaSwap := solana.AccountMetaSlice{
		...
		{PublicKey: solana.MustPublicKeyFromBase58("AMWjewk8jvQkqyrUv5cowmbQdoS2ChbJopXXPtVqKtch"), IsSigner: false, IsWritable: true},
		{PublicKey: solana.MustPublicKeyFromBase58("DfCb5imJ8AC966uqNrkSzi1hrzrbiyTW1t2XTgzLpZpZ"), IsSigner: false, IsWritable: true},
	}
